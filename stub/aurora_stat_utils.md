...
- [Official upstream documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora_wait_report.html)

`aurora_stat_utils` — Aurora PostgreSQL statistics utility functions for wait-event reporting.
