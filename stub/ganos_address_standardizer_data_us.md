...
`ganos_address_standardizer_data_us` — A placename standardization (United States) data extension based on the PAGC standard.

The reviewed catalog snapshot records version `7.0`, kind `puresql`, and implementation language `Data`.
