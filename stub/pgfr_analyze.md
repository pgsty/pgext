...
- [Official extension control file](https://github.com/dventimisupabase/pg_flight_recorder/blob/34517280f70b67ae8c8f99d18515550b629c9cd2/pgfr_analyze/extension.control)
- [Official project or provider page](https://dventimisupabase.github.io/pg_flight_recorder/)
- [Official primary documentation](https://database.dev/dventimi/pgfr_analyze)

`pgfr_analyze` — Reporting, anomaly detection, incident forensics, and capacity-planning functions for pgfr_record.
