...
|            [promtail](https://github.com/grafana/loki/releases/tag/v3.0.0)             | 3.0.0  |   APGLv3   | 2025年已弃用    |
...
|        [vector](https://github.com/vectordotdev/vector/releases)        | 0.51.1 |  MPL-2.0   | 多功能日志收集器             |
...
|                                          名称                                           |   版本   |    许可证     | 备注                     |
|:-------------------------------------------------------------------------------------:|:------:|:----------:|:-----------------------|
|                          [pig](https://github.com/pgsty/pig)                          | 0.8.0  | Apache-2.0 | PG 包管理器                |
