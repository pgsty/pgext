...
制品：[Pigsty 镜像](https://repo.pigsty.cc/pkg/pig/v1.6.0/) · [checksums.txt](https://repo.pigsty.cc/pkg/pig/v1.6.0/checksums.txt)
...
- 新增 PostgreSQL 19 beta 的 repo、tool、pgrx 显式构建开关，稳定默认值仍保持 PostgreSQL 18 与 PG14-18 窗口。
...
- 工程与发布：
  - 版本号提升到 `v1.3.0`，版权年份更新到 2026，README 同步更新到 461 扩展与最新 alias 说明。
- **兼容性提醒**
...
- 专门的新文档网站： https://pig.pgsty.com/zh
...
[`pig`](https://pig.pgsty.com/zh) 项目现在有了新的 [主页](https://pig.pgsty.com/zh)，以及 PostgreSQL 扩展 [目录](https://ext.pgsty.com/list)。
...
`pig build` 子命令具有设置扩展构建环境的 [能力](https://pig.pgsty.com/zh/build/)
