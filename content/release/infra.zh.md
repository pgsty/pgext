...
| claude                     | 2.1.172        | 2.1.187        | 通过 8118 代理下载并核验        |
| codex                      | 0.139.0        | 0.142.0        | 发布标签 `rust-v0.142.0`     |
| dblab                      | 0.40.1         | 0.42.0         |                          |
| duckdb                     | 1.5.3          | 1.5.4          |                          |
| grafana-victorialogs-ds    | 0.28.0         | 0.29.0         |                          |
| headscale                  | 0.28.0         | 0.29.1         |                          |
| hugo                       | 0.163.0        | 0.163.3        |                          |
| kafka                      | 4.3.0          | 4.3.1          | noarch 软件包               |
| minio                      | 20260417000000 | 20260618000000 | 已提前放置                    |
| nodejs                     | 24.16.0        | 24.18.0        | 保持在 24.x 策略线             |
| npgsqlrest                 | 3.16.3         | 3.18.1         |                          |
| opencode                   | 1.17.3         | 1.17.9         |                          |
| pev2                       | 1.21.0         | 1.22.0         | noarch 软件包               |
| pg_exporter                | 1.2.2          | 1.3.0          | 直链构建产物更新                |
| pgschema                   | 1.11.0         | 1.11.1         | 直链构建产物更新                |
| pgstream                   | 1.0.3          | 1.1.0          |                          |
| pig                        | 1.4.1          | 1.4.2          | 已提前放置                    |
...
| victoria-metrics-cluster   | 1.145.0        | 1.146.0        | VictoriaMetrics 配套组件       |
| vmutils                    | 1.145.0        | 1.146.0        | VictoriaMetrics 配套组件       |
| victoria-traces            | 0.9.2          | 0.9.3          |                          |
| code                       | 1.124.0        | 1.125.1        | 直链构建产物更新                |
| code-server                | 4.123.0        | 4.125.0        | 直链构建产物更新                |
| cloudflared                | 2026.6.0       | 2026.6.1       | 直链构建产物更新                |
| crush                      | 0.76.0         | 0.79.1         | 直链构建产物更新                |
| genai-toolbox              | 1.1.0          | 1.5.0          | 同步外部构建产物                 |
...
| node_exporter              | 1.11.1         | 1.11.1         |                          |
| redis_exporter             | 1.83.0         | 1.86.0         |                          |
| victoria-metrics           | 1.143.0        | 1.145.0        |                          |
| victoria-metrics-cluster   | 1.143.0        | 1.145.0        |                          |
| vmutils                    | 1.143.0        | 1.145.0        |                          |
...
| crush                      | 0.66.1         | 0.76.0         |                          |
| rclone                     | 1.74.1         | 1.74.3         |                          |
| code                       | 1.118.1        | 1.124.0        |                          |
| code-server                | 4.118.0        | 4.123.0        |                          |
| cloudflared                | 2026.3.0       | 2026.6.0       |                          |
...
| npgsqlrest     | -       | 3.3.3    | 新增                   |
| postgrest      | -       | 14.3     | 新增                   |
| claude         | 2.0.76  | 2.1.1    | 新增                   |
| genai-toolbox  | 0.23.0  | 0.24.0   | 移除 Oracle C 驱动     |
