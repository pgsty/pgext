...
当前 `pig` 最新稳定版本为：[v0.8.0](https://github.com/pgsty/pig/releases/tag/v0.8.0)。

| 版本                             |     日期     | 摘要                                |                           GitHub                           |
|:-------------------------------|:----------:|-----------------------------------|:----------------------------------------------------------:|
| [v0.8.0](/zh/release/pig#v080) | 2025-12-16 | 440 个扩展，Pigsty v4                 | [v0.8.0](https://github.com/pgsty/pig/releases/tag/v0.8.0) |
