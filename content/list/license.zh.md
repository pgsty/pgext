...
| 7110 | {{< alias "pgauditlogtofile" >}} | pgAudit 子扩展，将审计日志写入单独的文件中 |
| 7120 | {{< alias "pg_roast" >}} | 覆盖模式设计、安全配置、运行健康与查询行为的数据库审计器 |
...
| {{< license "LGPL-3.0" >}} | {{< badge content="4 个扩展" color="gray" icon="cube" >}}  |
|:----|:---|
