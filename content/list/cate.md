...
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.22.0 | Enables scalable inserts and complex queries for time-series data |
| 1010 | {{< alias "timescaledb_toolkit" >}} | 1.21.0 | Library of analytical hyperfunctions, time-series pipelining, and other SQL utilities |
| 1020 | {{< alias "timeseries" "pg_timeseries" >}} | 0.1.6 | Convenience API for time series stack |
...
| 1050 | {{< alias "emaj" >}} | 4.7.0 | Enables fine-grained write logging and time travel on subsets of the database. |
...
| 1090 | {{< alias "pg_later" >}} | 0.3.0 | Run queries now and get results later |
...
| 1650 | {{< alias "mobilitydb" >}} | 1.2.0 | MobilityDB geospatial trajectory data management & analysis platform |
| 1680 | {{< alias "tzf" "pg_tzf" >}} | 0.2.2 | Fast lookup timezone name by GPS coordinates |
...
| 3570 | {{< alias "roaringbitmap" >}} | 0.5.4 | support for Roaring Bitmaps |
| 3580 | {{< alias "pgfaceting" >}} | 0.2.0 | fast faceting queries using an inverted index |
| 3590 | {{< alias "pg_sphere" "pgsphere" >}} | 1.5.1 | spherical objects with useful functions, operators and index support |
...
| 3630 | {{< alias "collection" "pg_collection" >}} | 1.0.0 | Memory optimized data type to be used inside of plpglsql func |
...
| 3730 | {{< alias "uint" "pguint" >}} | 1.20231206 | unsigned integer types |
| 3740 | {{< alias "uint128" "pg_uint128" >}} | 1.1.0 | Native uint128 type |
...
| 3850 | {{< alias "emailaddr" "pgemailaddr" >}} | 0 | Email address type for PostgreSQL |
...
| 9100 | {{< alias "orafce" >}} | 4.14.4 | Functions and operators that emulate a subset of functions and packages from the Oracle RDBMS |
...
| ID | Extension / Package | Version | Description |
|:---:|:---|:---|:---|
| 9500 | {{< alias "pglogical" >}} | 2.4.5 | PostgreSQL Logical Replication |
| 9501 | {{< alias "pglogical_origin" "pglogical" >}} | 2.4.5 | Dummy extension for compatibility when upgrading from Postgres 9.4 |
...
| 9530 | {{< alias "pg_failover_slots" >}} | 1.1.0 | PG Failover Slots extension |
| 9540 | {{< alias "db_migrator" >}} | 1.0.0 | Tools to migrate other databases to PostgreSQL |
| 9550 | {{< alias "pgactive" >}} | 2.1.6 | Active-Active Replication Extension for PostgreSQL |
