...
PostgreSQL 扩展（508 ext / 425 pkg）归属 16 个分类。
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.26.3 | 时序数据库扩展插件 |
...
| 2180 | {{< alias "pg_textsearch" >}} | 1.0.0 | 带有BM25排序的全文搜索扩展 |
...
| 2450 | {{< alias "storage_engine" >}} | 1.2.3 | 带向量化执行的 colcompress 与 rowcompress 表访问方法 |
...
| 2860 | {{< alias "pg_trickle" >}} | 0.31.0 | 为 PostgreSQL 18 提供流式表与差分视图维护 |
...
| 4130 | {{< alias "pgproto" >}} | 0.3.3 | 原生 Protobuf 解析、修改、索引与 JSON 转换支持 |
