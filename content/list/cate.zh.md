...
| 1110 | {{< alias "pg_background" >}} | 1.8 | 在后台运行 SQL 查询 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 2100 | {{< alias "pg_search" >}} | 0.22.5 | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| 7120 | {{< alias "pgauditlogtofile" >}} | 1.8.0 | pgAudit 子扩展，将审计日志写入单独的文件中 |
