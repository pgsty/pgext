...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.25.1 | 时序数据库扩展插件 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 2100 | {{< alias "pg_search" >}} | 0.21.10 | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| 7120 | {{< alias "pgauditlogtofile" >}} | 1.7.7 | pgAudit 子扩展，将审计日志写入单独的文件中 |
