...
PostgreSQL 扩展（481 ext / 404 pkg）归属 16 个分类。
...
| 2860 | {{< alias "pg_trickle" >}} | 0.16.0 | 为 PostgreSQL 18 提供流式表与差分视图维护 |
...
| 3630 | {{< alias "collection" "pgcollection" >}} | 2.0.0 | 在PlPGSQL中使用的内存优化高性能集合数据结构 |
...
| 4130 | {{< alias "pgproto" >}} | 0.2.1 | 原生 Protobuf 解析、修改、索引与 JSON 转换支持 |
...
| 6020 | {{< alias "pg_stat_ch" >}} | 0.3.3 | 将 PostgreSQL 查询遥测实时导出到 ClickHouse |
...
| 9590 | {{< alias "pgclone" >}} | 2.2.0 | 在不同环境间克隆 PostgreSQL 数据库、模式、表和函数 |
