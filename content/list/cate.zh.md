...
PostgreSQL 扩展（464 ext / 387 pkg）归属 16 个分类。
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.25.2 | 时序数据库扩展插件 |
...
| 1100 | {{< alias "pg_background" >}} | 1.8 | 在后台运行 SQL 查询 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 2100 | {{< alias "pg_search" >}} | 0.22.2 | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| 2460 | {{< alias "pg_clickhouse" >}} | 0.1.5 | 从PostgreSQL中查询ClickHouse的接口 |
