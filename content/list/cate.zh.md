...
PostgreSQL 扩展（511 ext / 428 pkg）归属 16 个分类。
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.27.0 | 时序数据库扩展插件 |
...
| 2450 | {{< alias "storage_engine" >}} | 2.3.0 | 带向量化执行的 colcompress 与 rowcompress 表访问方法 |
| 2460 | {{< alias "pg_clickhouse" >}} | 0.3.0 | 从PostgreSQL中查询ClickHouse的接口 |
...
| 2900 | {{< alias "provsql" >}} | 1.4.0 | PostgreSQL 半环溯源与不确定性管理扩展 |
