...
PostgreSQL 扩展（531 ext / 448 pkg）归属 16 个分类。
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.28.0 | 时序数据库扩展插件 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1500 | {{< alias "postgis" >}} | 3.6.4 | PostGIS 几何和地理空间扩展 |
| 1501 | {{< alias "postgis_topology" "postgis" >}} | 3.6.4 | PostGIS 拓扑空间类型和函数 |
| 1502 | {{< alias "postgis_raster" "postgis" >}} | 3.6.4 | PostGIS 光栅类型和函数 |
| 1503 | {{< alias "postgis_sfcgal" "postgis" >}} | 3.6.4 | PostGIS SFCGAL 函数 |
...
| 1550 | {{< alias "ogr_fdw" >}} | 1.1.8 | GIS 数据外部数据源包装器 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1800 | {{< alias "vector" "pgvector" >}} | 0.8.3 | 向量数据类型和 ivfflat / hnsw 访问方法 |
...
| 2170 | {{< alias "biscuit" "pg_biscuit" >}} | 2.3.0 | 使用IAM的高性能文本模式匹配 |
| 2180 | {{< alias "pg_textsearch" >}} | 1.2.0 | 带有BM25排序的全文搜索扩展 |
| 2190 | {{< alias "pg_pinyin" >}} | 0.0.4 | PostgreSQL 拼音转写与检索辅助扩展 |
| 2200 | {{< alias "pg_kazsearch" >}} | 2.2.0 | PostgreSQL 哈萨克语全文检索扩展 |
...
| 2640 | {{< alias "pgrdf" >}} | 0.6.4 | PostgreSQL 内 RDF、SPARQL、SHACL 与 OWL 推理扩展 |
...
| 2900 | {{< alias "provsql" >}} | 1.10.0 | PostgreSQL 半环溯源与不确定性管理扩展 |
...
| 4070 | {{< alias "http" "pg_http" >}} | 1.7.1 | HTTP客户端，允许在数据库内收发HTTP请求 (supabase) |
...
| 6870 | {{< alias "powa" >}} | 5.1.2 | PostgreSQL 工作负载分析器-核心 |
...
| 7070 | {{< alias "anon" "pg_anon" >}} | 3.1.1 | 数据匿名化处理工具 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 8500 | {{< alias "wrappers" >}} | 0.6.1 | Supabase提供的外部数据源包装器捆绑包 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 9000 | {{< alias "documentdb" >}} | 0.112 | 微软DocumentDB的API层 |
| 9010 | {{< alias "documentdb_core" "documentdb" >}} | 0.112 | 微软DocumentDB的核心API层实现 |
| 9020 | {{< alias "documentdb_distributed" "documentdb" >}} | 0.112 | DocumentDB多节点模式的API层 |
| 9030 | {{< alias "documentdb_extended_rum" "documentdb" >}} | 0.112 | DocumentDB扩展RUM索引访问方法 |
...
| 9200 | {{< alias "db2fce" >}} | 0.0.17 | 为 PostgreSQL 提供 DB2 兼容函数、类型、操作符与 SYSIBM.SYSDUMMY1。 |
| 9210 | {{< alias "plpgsql_wrap" >}} | 1.0 | Oracle WRAP 等价的 PL/pgSQL 语言处理器，以 AES-256-GCM 加密存储过程源码。 |
...
| 9620 | {{< alias "pgmqtt" >}} | 0.3.0 | PostgreSQL 的 CDC 到 MQTT 代理扩展 |
