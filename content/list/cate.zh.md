...
PostgreSQL 扩展（504 ext / 421 pkg）归属 16 个分类。
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 2100 | {{< alias "pg_search" >}} | 0.22.6 | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| 2460 | {{< alias "pg_clickhouse" >}} | 0.1.10 | 从PostgreSQL中查询ClickHouse的接口 |
...
| 2705 | {{< alias "pg_liquid" >}} | 0.1.7 | 受 Liquid 启发的 Datalog 图查询扩展 |
...
| 2980 | {{< alias "onesparse" "one_sparse" >}} | 1.0.0 | PostgreSQL 18 的稀疏线性代数与图算法扩展 |
...
| 4130 | {{< alias "pgproto" >}} | 0.2.4 | 原生 Protobuf 解析、修改、索引与 JSON 转换支持 |
...
| 6020 | {{< alias "pg_stat_ch" >}} | 0.3.4 | 将 PostgreSQL 查询遥测实时导出到 ClickHouse |
...
| 9590 | {{< alias "pgclone" >}} | 3.6.0 | 在不同环境间克隆 PostgreSQL 数据库、模式、表和函数 |
