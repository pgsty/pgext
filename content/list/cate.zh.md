...
PostgreSQL 扩展（507 ext / 424 pkg）归属 16 个分类。
...
| 2450 | {{< alias "storage_engine" >}} | 1.0.7 | 带向量化执行的 colcompress 与 rowcompress 表访问方法 |
...
| 2660 | {{< alias "pgmq" >}} | 1.11.0 | 基于Postgres实现类似AWS SQS/RSMQ的消息队列 |
...
| 2860 | {{< alias "pg_trickle" >}} | 0.20.0 | 为 PostgreSQL 18 提供流式表与差分视图维护 |
...
| 4860 | {{< alias "parray_gin" >}} | 1.4.0 | 为 text[] 提供部分匹配运算符与 GIN 索引支持 |
...
| 8760 | {{< alias "rdf_fdw" >}} | 2.4.0 | 通过 SPARQL 端点访问 RDF 三元组存储的 FDW |
