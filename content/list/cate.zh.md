...
PostgreSQL 扩展（510 ext / 427 pkg）归属 16 个分类。
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.26.4 | 时序数据库扩展插件 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 2100 | {{< alias "pg_search" >}} | 0.23.1 | ParadeDB BM25算法全文检索插件，ES全文检索 |
...
| 2180 | {{< alias "pg_textsearch" >}} | 1.1.0 | 带有BM25排序的全文搜索扩展 |
| 2190 | {{< alias "pg_pinyin" >}} | 0.0.2 | PostgreSQL 拼音转写与检索辅助扩展 |
...
| 2450 | {{< alias "storage_engine" >}} | 1.3.4 | 带向量化执行的 colcompress 与 rowcompress 表访问方法 |
| 2460 | {{< alias "pg_clickhouse" >}} | 0.2.0 | 从PostgreSQL中查询ClickHouse的接口 |
...
| 2740 | {{< alias "pg_ttl_index" >}} | 3.0.0 | 基于TTL索引的自动数据过期清理 |
...
| 2860 | {{< alias "pg_trickle" >}} | 0.40.0 | 为 PostgreSQL 18 提供流式表与差分视图维护 |
| 2900 | {{< alias "provsql" >}} | 1.2.3 | PostgreSQL 半环溯源与不确定性管理扩展 |
...
| 3770 | {{< alias "ip4r" >}} | 2.4.2 | PostgreSQL 的 IPv4/v6 和 IPv4/v6 范围索引类型 |
...
| 4235 | {{< alias "re2" >}} | 0.1.1 | 使用 RE2 的 ClickHouse 兼容正则函数 |
...
| 4530 | {{< alias "permuteseq" >}} | 1.2.2 | 伪随机数ID置换生成器 |
| 4540 | {{< alias "pg_hashids" >}} | 1.3 | 加盐将整型ID转为短字符串ID |
| 4550 | {{< alias "pg_slug_gen" >}} | 1.0.0 | 生成带时间戳的加密安全短标识 |
...
| 7120 | {{< alias "pgauditlogtofile" >}} | 1.8.3 | pgAudit 子扩展，将审计日志写入单独的文件中 |
...
| 9100 | {{< alias "orafce" >}} | 4.16.5 | 模拟 Oracle RDBMS 的一部分函数和包的函数和运算符 |
...
| 9590 | {{< alias "pgclone" >}} | 4.0.0 | 在不同环境间克隆 PostgreSQL 数据库、模式、表和函数 |
