...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1000 | {{< alias "timescaledb" >}} | 2.28.2 | 时序数据库扩展插件 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 1800 | {{< alias "vector" "pgvector" >}} | 0.8.4 | 向量数据类型和 ivfflat / hnsw 访问方法 |
...
| 1900 | {{< alias "pgmnemo" >}} | 0.12.1 | 面向 LLM 代理的 PostgreSQL 溯源向量记忆扩展 |
...
| 2170 | {{< alias "biscuit" "pg_biscuit" >}} | 2.4.1 | 使用IAM的高性能文本模式匹配 |
...
| 3060 | {{< alias "plpgsql_check" >}} | 2.9.2 | 对 plpgsql 函数进行扩展检查 |
