...
| 2170 | {{< alias "biscuit" "pg_biscuit" >}} | 2.4.0 | 使用IAM的高性能文本模式匹配 |
...
| 5120 | {{< alias "pg_readonly" >}} | 1.0.5 | 将集群设置为只读 |
...
| ID | 扩展/包 | 版本 | 描述 |
|:---:|:---|:---|:---|
| 9000 | {{< alias "documentdb" >}} | 0.113 | 微软DocumentDB的API层 |
| 9010 | {{< alias "documentdb_core" "documentdb" >}} | 0.113 | 微软DocumentDB的核心API层实现 |
| 9020 | {{< alias "documentdb_distributed" "documentdb" >}} | 0.113 | DocumentDB多节点模式的API层 |
| 9030 | {{< alias "documentdb_extended_rum" "documentdb" >}} | 0.113 | DocumentDB扩展RUM索引访问方法 |
...
| 9110 | {{< alias "pgtt" >}} | 4.5 | 类似Oracle的全局临时表功能 |
...
| 9250 | {{< alias "pg_dbms_lock" >}} | 2.0 | 为PG添加对 Oracle DBMS_LOCK 的完整兼容性支持 |
