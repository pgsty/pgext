...
这正是 **Pig** 诞生的初衷。Pig 由 Go 语言开发，致力于一站式管理 Postgres 及其 [531](https://pgext.cloud/zh/list) 个扩展。
...
如果你的 Linux 系统和 PostgreSQL 大版本不在 [支持的列表](#linux-兼容性) 中，你还可以使用 [`pig build`](/zh/pig/cmd/build) 直接针对特定组合编译扩展。

想让你的 Postgres 如虎添翼、远离繁琐？欢迎访问 [PIG 官方文档](https://pigsty.io/docs/pig) 获取文档、指南，并查阅庞大的 [扩展列表](https://pgext.cloud/zh/list)，
...
|:---------------|:-------|:---:|:-------:|:------------------|:------|:-----:|
| `el7.x86_64`   | EL     |  7  |   7.9   | CentOS 7 x86      | 14-15 |  EOL  |
...
| `d12.x86_64`   | Debian | 12  |  12.3   | Debian 12 x86     | 14-18 |   ✅   |
| `d12.aarch64`  | Debian | 12  |  12.3   | Debian 12 ARM     | 14-18 |   ✅   |
