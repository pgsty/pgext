...
Current `v1.8.0` installation packages (`RPM`/`DEB`/tarball) are available from:

- [GitHub Release](https://github.com/pgsty/pig/releases/tag/v1.8.0)
- [checksums.txt](https://github.com/pgsty/pig/releases/download/v1.8.0/checksums.txt)

Use `https://github.com/pgsty/pig/releases/download/v1.8.0/<filename>` for direct downloads.
