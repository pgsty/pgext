...
> [!Note] Configure oauth_validator_libraries='oidc_validator'. no valid license, distribution suspend
...
|:------------|:-----------:|:------:|:-------:|:--------:|:--------------|
| `pg_oidc_validator_rust_18` | `0.1.0` | [el8.x86_64](/os/el8.x86_64) | pigsty | 3.0 MiB | [pg_oidc_validator_rust_18-0.1.0-2PGSTY.el8.x86_64.rpm](https://repo.pigsty.io/yum/pgsql/el8.x86_64/pg_oidc_validator_rust_18-0.1.0-2PGSTY.el8.x86_64.rpm) |
| `pg_oidc_validator_rust_18` | `0.1.0` | [el8.aarch64](/os/el8.aarch64) | pigsty | 2.9 MiB | [pg_oidc_validator_rust_18-0.1.0-2PGSTY.el8.aarch64.rpm](https://repo.pigsty.io/yum/pgsql/el8.aarch64/pg_oidc_validator_rust_18-0.1.0-2PGSTY.el8.aarch64.rpm) |
| `pg_oidc_validator_rust_18` | `0.1.0` | [el9.x86_64](/os/el9.x86_64) | pigsty | 3.0 MiB | [pg_oidc_validator_rust_18-0.1.0-2PGSTY.el9.x86_64.rpm](https://repo.pigsty.io/yum/pgsql/el9.x86_64/pg_oidc_validator_rust_18-0.1.0-2PGSTY.el9.x86_64.rpm) |
| `pg_oidc_validator_rust_18` | `0.1.0` | [el9.aarch64](/os/el9.aarch64) | pigsty | 3.0 MiB | [pg_oidc_validator_rust_18-0.1.0-2PGSTY.el9.aarch64.rpm](https://repo.pigsty.io/yum/pgsql/el9.aarch64/pg_oidc_validator_rust_18-0.1.0-2PGSTY.el9.aarch64.rpm) |
| `pg_oidc_validator_rust_18` | `0.1.0` | [el10.x86_64](/os/el10.x86_64) | pigsty | 3.0 MiB | [pg_oidc_validator_rust_18-0.1.0-2PGSTY.el10.x86_64.rpm](https://repo.pigsty.io/yum/pgsql/el10.x86_64/pg_oidc_validator_rust_18-0.1.0-2PGSTY.el10.x86_64.rpm) |
| `pg_oidc_validator_rust_18` | `0.1.0` | [el10.aarch64](/os/el10.aarch64) | pigsty | 3.0 MiB | [pg_oidc_validator_rust_18-0.1.0-2PGSTY.el10.aarch64.rpm](https://repo.pigsty.io/yum/pgsql/el10.aarch64/pg_oidc_validator_rust_18-0.1.0-2PGSTY.el10.aarch64.rpm) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [d12.x86_64](/os/d12.x86_64) | pigsty | 2.4 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~bookworm_amd64.deb](https://repo.pigsty.io/apt/pgsql/bookworm/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~bookworm_amd64.deb) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [d12.aarch64](/os/d12.aarch64) | pigsty | 2.1 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~bookworm_arm64.deb](https://repo.pigsty.io/apt/pgsql/bookworm/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~bookworm_arm64.deb) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [d13.x86_64](/os/d13.x86_64) | pigsty | 2.4 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~trixie_amd64.deb](https://repo.pigsty.io/apt/pgsql/trixie/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~trixie_amd64.deb) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [d13.aarch64](/os/d13.aarch64) | pigsty | 2.1 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~trixie_arm64.deb](https://repo.pigsty.io/apt/pgsql/trixie/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~trixie_arm64.deb) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [u22.x86_64](/os/u22.x86_64) | pigsty | 2.6 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~jammy_amd64.deb](https://repo.pigsty.io/apt/pgsql/jammy/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~jammy_amd64.deb) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [u22.aarch64](/os/u22.aarch64) | pigsty | 2.5 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~jammy_arm64.deb](https://repo.pigsty.io/apt/pgsql/jammy/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~jammy_arm64.deb) |
| `postgresql-18-pg-oidc-validator-rust` | `0.1.0` | [u24.x86_64](/os/u24.x86_64) | pigsty | 2.6 MiB | [postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~noble_amd64.deb](https://repo.pigsty.io/apt/pgsql/noble/pool/main/p/pg-oidc-validator-rust/postgresql-18-pg-oidc-validator-rust_0.1.0-2PGSTY~noble_amd64.deb) |
