...
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
| {{< os "el8.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "pg_oidc_validator_rust_18 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_oidc_validator_rust_17 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_14 : MISS 0" "red" >}}      |
| {{< os "el8.aarch64" >}} | {{< bg "PIGSTY 0.1.0" "pg_oidc_validator_rust_18 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_oidc_validator_rust_17 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_14 : MISS 0" "red" >}}      |
| {{< os "el9.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "pg_oidc_validator_rust_18 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_oidc_validator_rust_17 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_14 : MISS 0" "red" >}}      |
| {{< os "el9.aarch64" >}} | {{< bg "PIGSTY 0.1.0" "pg_oidc_validator_rust_18 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_oidc_validator_rust_17 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_14 : MISS 0" "red" >}}      |
| {{< os "el10.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "pg_oidc_validator_rust_18 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_oidc_validator_rust_17 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_14 : MISS 0" "red" >}}      |
| {{< os "el10.aarch64" >}} | {{< bg "PIGSTY 0.1.0" "pg_oidc_validator_rust_18 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_oidc_validator_rust_17 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_oidc_validator_rust_14 : MISS 0" "red" >}}      |
| {{< os "d12.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
| {{< os "d12.aarch64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
| {{< os "d13.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
| {{< os "d13.aarch64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
| {{< os "u22.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
| {{< os "u22.aarch64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
| {{< os "u24.x86_64" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-18-pg-oidc-validator-rust : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pg-oidc-validator-rust : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pg-oidc-validator-rust : MISS 0" "red" >}}      |
