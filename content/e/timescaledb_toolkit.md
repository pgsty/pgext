...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **1010** | {{< badge content="timescaledb_toolkit" link="https://github.com/timescale/timescaledb-toolkit" >}} | {{< ext "timescaledb_toolkit" >}} | `1.21.0` | {{< category "TIME" >}} | {{< license "Timescale" >}} | {{< language "Rust" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PIGSTY" link="/e/timescaledb_toolkit" >}} | `1.21.0` | {{< bg "18" "timescaledb-toolkit_18" "red" >}} {{< bg "17" "timescaledb-toolkit_17" "green" >}} {{< bg "16" "timescaledb-toolkit_16" "green" >}} {{< bg "15" "timescaledb-toolkit_15" "green" >}} {{< bg "14" "timescaledb-toolkit_14" "green" >}} | `timescaledb-toolkit_$v` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/timescaledb_toolkit" >}} | `1.21.0` | {{< bg "18" "postgresql-18-timescaledb-toolkit" "red" >}} {{< bg "17" "postgresql-17-timescaledb-toolkit" "green" >}} {{< bg "16" "postgresql-16-timescaledb-toolkit" "green" >}} {{< bg "15" "postgresql-15-timescaledb-toolkit" "green" >}} {{< bg "14" "postgresql-14-timescaledb-toolkit" "green" >}} | `postgresql-$v-timescaledb-toolkit` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    |      {{< bg "MISS" "timescaledb-toolkit_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_16 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_15 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.19.0" "timescaledb-toolkit_14 : AVAIL 1" "green" >}} |
|    `el8.aarch64`    |      {{< bg "MISS" "timescaledb-toolkit_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_16 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_15 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.19.0" "timescaledb-toolkit_14 : AVAIL 1" "green" >}} |
|    `el9.x86_64`    |      {{< bg "MISS" "timescaledb-toolkit_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_16 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_15 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.19.0" "timescaledb-toolkit_14 : AVAIL 1" "green" >}} |
|    `el9.aarch64`    |      {{< bg "MISS" "timescaledb-toolkit_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_16 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.21.0" "timescaledb-toolkit_15 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.19.0" "timescaledb-toolkit_14 : AVAIL 1" "green" >}} |
|    `d12.x86_64`    |      {{< bg "MISS" "postgresql-18-timescaledb-toolkit : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.21.0" "postgresql-17-timescaledb-toolkit : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.21.0" "postgresql-16-timescaledb-toolkit : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.21.0" "postgresql-15-timescaledb-toolkit : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.19.0" "postgresql-14-timescaledb-toolkit : AVAIL 1" "green" >}} |
...
{{< card link="/list" title="Source Tarball" icon="clipboard-list" subtitle="timescaledb-toolkit-1.21.0.tar.gz" >}}
{{< /cards >}}
