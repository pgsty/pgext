...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `1.2.0` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} {{< bg "13" "" "green" >}} | `pg_failover_slots` | - |
| **RPM** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `1.2.0` | {{< bg "18" "pg_failover_slots_18*" "green" >}} {{< bg "17" "pg_failover_slots_17*" "green" >}} {{< bg "16" "pg_failover_slots_16*" "green" >}} {{< bg "15" "pg_failover_slots_15*" "green" >}} {{< bg "14" "pg_failover_slots_14*" "green" >}} {{< bg "13" "pg_failover_slots_13*" "green" >}} | `pg_failover_slots_$v*` | - |
| **DEB** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `1.2.0` | {{< bg "18" "postgresql-18-pg-failover-slots" "green" >}} {{< bg "17" "postgresql-17-pg-failover-slots" "green" >}} {{< bg "16" "postgresql-16-pg-failover-slots" "green" >}} {{< bg "15" "postgresql-15-pg-failover-slots" "green" >}} {{< bg "14" "postgresql-14-pg-failover-slots" "green" >}} {{< bg "13" "postgresql-13-pg-failover-slots" "green" >}} | `postgresql-$v-pg-failover-slots` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |                  **PG13**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
| {{< os "el8.x86_64" >}} | {{< bg "PIGSTY 1.2.0" "pg_failover_slots_18 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.2.0" "pg_failover_slots_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.2.0" "pg_failover_slots_16 : AVAIL 3" "green" >}} | {{< bg "PIGSTY 1.2.0" "pg_failover_slots_15 : AVAIL 4" "green" >}} | {{< bg "PIGSTY 1.2.0" "pg_failover_slots_14 : AVAIL 4" "green" >}} | {{< bg "PIGSTY 1.2.0" "pg_failover_slots_13 : AVAIL 4" "green" >}} |
...
| `pg_failover_slots_18` | `1.2.0` | [el10.aarch64](/os/el10.aarch64) | pgdg | 25.1 KiB | [pg_failover_slots_18-1.2.0-1PGDG.rhel10.aarch64.rpm](https://download.postgresql.org/pub/repos/yum/18/redhat/rhel-10.0-aarch64/pg_failover_slots_18-1.2.0-1PGDG.rhel10.aarch64.rpm) |
...
| `pg_failover_slots_17` | `1.1.0` | [el10.aarch64](/os/el10.aarch64) | pgdg | 25.2 KiB | [pg_failover_slots_17-1.1.0-3PGDG.rhel10.aarch64.rpm](https://download.postgresql.org/pub/repos/yum/17/redhat/rhel-10.0-aarch64/pg_failover_slots_17-1.1.0-3PGDG.rhel10.aarch64.rpm) |
...
| `pg_failover_slots_16` | `1.1.0` | [el10.aarch64](/os/el10.aarch64) | pgdg | 25.2 KiB | [pg_failover_slots_16-1.1.0-3PGDG.rhel10.aarch64.rpm](https://download.postgresql.org/pub/repos/yum/16/redhat/rhel-10.0-aarch64/pg_failover_slots_16-1.1.0-3PGDG.rhel10.aarch64.rpm) |
...
| `pg_failover_slots_15` | `1.1.0` | [el10.aarch64](/os/el10.aarch64) | pgdg | 25.5 KiB | [pg_failover_slots_15-1.1.0-3PGDG.rhel10.aarch64.rpm](https://download.postgresql.org/pub/repos/yum/15/redhat/rhel-10.0-aarch64/pg_failover_slots_15-1.1.0-3PGDG.rhel10.aarch64.rpm) |
...
| `pg_failover_slots_14` | `1.1.0` | [el10.aarch64](/os/el10.aarch64) | pgdg | 25.5 KiB | [pg_failover_slots_14-1.1.0-3PGDG.rhel10.aarch64.rpm](https://download.postgresql.org/pub/repos/yum/14/redhat/rhel-10.0-aarch64/pg_failover_slots_14-1.1.0-3PGDG.rhel10.aarch64.rpm) |
...
| `pg_failover_slots_13` | `1.1.0` | [el10.aarch64](/os/el10.aarch64) | pgdg | 25.5 KiB | [pg_failover_slots_13-1.1.0-3PGDG.rhel10.aarch64.rpm](https://download.postgresql.org/pub/repos/yum/13/redhat/rhel-10.0-aarch64/pg_failover_slots_13-1.1.0-3PGDG.rhel10.aarch64.rpm) |
...
pig install pg_failover_slots -v 13;   # install for PG 13
