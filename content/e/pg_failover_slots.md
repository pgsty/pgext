...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **9530** | {{< badge content="pg_failover_slots" link="https://github.com/EnterpriseDB/pg_failover_slots" >}} | {{< ext "pg_failover_slots" >}} | `1.1.0` | {{< category "ETL" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PIGSTY" link="/e/pg_failover_slots" >}} | `1.1.0` | {{< bg "18" "pg_failover_slots_18*" "red" >}} {{< bg "17" "pg_failover_slots_17*" "green" >}} {{< bg "16" "pg_failover_slots_16*" "green" >}} {{< bg "15" "pg_failover_slots_15*" "green" >}} {{< bg "14" "pg_failover_slots_14*" "green" >}} | `pg_failover_slots_$v*` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/pg_failover_slots" >}} | `1.1.0` | {{< bg "18" "postgresql-18-pg-failover-slots" "red" >}} {{< bg "17" "postgresql-17-pg-failover-slots" "green" >}} {{< bg "16" "postgresql-16-pg-failover-slots" "green" >}} {{< bg "15" "postgresql-15-pg-failover-slots" "green" >}} {{< bg "14" "postgresql-14-pg-failover-slots" "green" >}} | `postgresql-$v-pg-failover-slots` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    | {{< bg "PGDG 1.2.0" "pg_failover_slots_18 : AVAIL 1" "blue" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_16 : AVAIL 3" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_15 : AVAIL 4" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_14 : AVAIL 4" "green" >}} |
|    `el8.aarch64`    | {{< bg "PGDG 1.2.0" "pg_failover_slots_18 : AVAIL 1" "blue" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_16 : AVAIL 3" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_15 : AVAIL 4" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_14 : AVAIL 4" "green" >}} |
|    `el9.x86_64`    | {{< bg "PGDG 1.2.0" "pg_failover_slots_18 : AVAIL 1" "blue" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_16 : AVAIL 3" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_15 : AVAIL 4" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_14 : AVAIL 4" "green" >}} |
|    `el9.aarch64`    | {{< bg "PGDG 1.2.0" "pg_failover_slots_18 : AVAIL 1" "blue" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_16 : AVAIL 3" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_15 : AVAIL 4" "green" >}} | {{< bg "PIGSTY 1.1.0" "pg_failover_slots_14 : AVAIL 4" "green" >}} |
|    `d12.x86_64`    | {{< bg "PGDG 1.2.0" "postgresql-18-pg-failover-slots : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-17-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-16-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-15-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-14-pg-failover-slots : AVAIL 2" "blue" >}} |
|    `d12.aarch64`    | {{< bg "PGDG 1.2.0" "postgresql-18-pg-failover-slots : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-17-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-16-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-15-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-14-pg-failover-slots : AVAIL 2" "blue" >}} |
...
|    `u22.aarch64`    | {{< bg "PGDG 1.2.0" "postgresql-18-pg-failover-slots : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-17-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-16-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-15-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-14-pg-failover-slots : AVAIL 2" "blue" >}} |
|    `u24.x86_64`    | {{< bg "PGDG 1.2.0" "postgresql-18-pg-failover-slots : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-17-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-16-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-15-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-14-pg-failover-slots : AVAIL 2" "blue" >}} |
|    `u24.aarch64`    | {{< bg "PGDG 1.2.0" "postgresql-18-pg-failover-slots : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-17-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-16-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-15-pg-failover-slots : AVAIL 2" "blue" >}} | {{< bg "PGDG 1.2.0" "postgresql-14-pg-failover-slots : AVAIL 2" "blue" >}} |
...
{{< card link="/list" title="Source Tarball" icon="clipboard-list" subtitle="pg_failover_slots-1.1.0.tar.gz" >}}
{{< /cards >}}
