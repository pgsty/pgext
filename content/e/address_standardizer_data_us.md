...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **1506** | {{< badge content="address_standardizer_data_us" link="https://git.osgeo.org/gitea/postgis/postgis" >}} | {{< ext "address_standardizer_data_us" "postgis" >}} | `3.6.0` | {{< category "GIS" >}} | {{< license "GPL-2.0" >}} | {{< language "C" >}} |
