...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2986** | {{< badge content="omni_web" link="https://docs.omnigres.org/omni_web/intro/" >}} | {{< ext "omni_web" "omnigres" >}} | `0.3.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
```bash
pig build get omni_web; # get omni_web source code
pig build dep omni_web; # install build dependencies
pig build pkg omni_web; # build extension rpm or deb
pig build ext omni_web; # build extension rpms
```
...
pig ext install omni_web -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_web CASCADE SCHEMA omni_web;
```
