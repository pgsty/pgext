...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **5900** | {{< badge content="pgpool_adm" link="https://pgpool.net/" >}} | {{< ext "pgpool_adm" "pgpool" >}} | `4.6.3` | {{< category "ADMIN" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
...
pig ext install pgpool_adm -v 18;   # install for PG 18
