...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **1020** | {{< badge content="timeseries" link="https://github.com/ChuckHend/pg_timeseries" >}} | {{< ext "timeseries" "pg_timeseries" >}} | `0.1.6` | {{< category "TIME" >}} | {{< license "PostgreSQL" >}} | {{< language "SQL" >}} |
