...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pgdd : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-pgdd : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-pgdd : MISS 0" "red" >}}      |
