...
[**hunspell**](https://github.com/postgrespro/hunspell_dicts) : Portuguese Hunspell Dictionary
...
pig install hunspell_pt_pt;		# install by extension name, for the current active PG version
