...
[**omni_shmem**](https://docs.omnigres.org/omni_shmem/)
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PIGSTY" link="/e/omni_shmem" >}} | `0.1.0` | {{< bg "18" "omnigres_18" "green" >}} {{< bg "17" "omnigres_17" "green" >}} {{< bg "16" "omnigres_16" "green" >}} {{< bg "15" "omnigres_15" "green" >}} {{< bg "14" "omnigres_14" "green" >}} {{< bg "13" "omnigres_13" "green" >}} | `omnigres_$v` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/omni_shmem" >}} | `0.1.0` | {{< bg "18" "postgresql-18-omnigres" "green" >}} {{< bg "17" "postgresql-17-omnigres" "green" >}} {{< bg "16" "postgresql-16-omnigres" "green" >}} {{< bg "15" "postgresql-15-omnigres" "green" >}} {{< bg "14" "postgresql-14-omnigres" "green" >}} {{< bg "13" "postgresql-13-omnigres" "green" >}} | `postgresql-$v-omnigres` | - |
...
```bash
pig build get omni_shmem; # get omni_shmem source code
pig build dep omni_shmem; # install build dependencies
pig build pkg omni_shmem; # build extension rpm or deb
pig build ext omni_shmem; # build extension rpms
```
...
```bash
pig ext install omni_shmem; # install by extension name, for the current active PG version
pig ext install omni_shmem; # install via package alias, for the active PG version
pig ext install omni_shmem -v 18;   # install for PG 18
pig ext install omni_shmem -v 17;   # install for PG 17
pig ext install omni_shmem -v 16;   # install for PG 16
pig ext install omni_shmem -v 15;   # install for PG 15
pig ext install omni_shmem -v 14;   # install for PG 14
pig ext install omni_shmem -v 13;   # install for PG 13
...
```bash
CREATE EXTENSION omni_shmem CASCADE SCHEMA omni_shmem;
```
