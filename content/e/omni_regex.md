...
[**omnigres**](https://docs.omnigres.org/omni_regex/regex/)
...
```bash
pig build get omni_regex; # get omni_regex source code
pig build dep omni_regex; # install build dependencies
pig build pkg omni_regex; # build extension rpm or deb
pig build ext omni_regex; # build extension rpms
```
...
pig ext install omni_regex -v 18;   # install for PG 18
