...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **9020** | {{< badge content="documentdb_distributed" link="https://github.com/microsoft/documentdb" >}} | {{< ext "documentdb_distributed" "documentdb" >}} | `0.107` | {{< category "SIM" >}} | {{< license "MIT" >}} | {{< language "C" >}} |
