...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2973** | {{< badge content="omni_var" link="https://docs.omnigres.org/omni_var/variables/" >}} | {{< ext "omni_var" "omnigres" >}} | `0.3.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
{{< cards cols=3 >}}
{{< card link="https://docs.omnigres.org/omni_var/variables/" title="Repository" icon="link" subtitle="docs.omnigres.org/omni_var/variables/" >}}
...
pig install omni_var;		# install by extension name, for the current active PG version

pig install omni_var -v 18;   # install for PG 18
pig install omni_var -v 17;   # install for PG 17
pig install omni_var -v 16;   # install for PG 16
pig install omni_var -v 15;   # install for PG 15
pig install omni_var -v 14;   # install for PG 14
