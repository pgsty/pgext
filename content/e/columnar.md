...
| {{< os "d13.x86_64" >}} |  {{< bg "MISS" "postgresql-18-hydra : HIDE 0" "red" >}}   |  {{< bg "MISS" "postgresql-17-hydra : HIDE 0" "red" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-16-hydra : HIDE 1" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-15-hydra : HIDE 1" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-14-hydra : HIDE 1" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-13-hydra : HIDE 1" >}}   |
| {{< os "d13.aarch64" >}} |  {{< bg "MISS" "postgresql-18-hydra : HIDE 0" "red" >}}   |  {{< bg "MISS" "postgresql-17-hydra : HIDE 0" "red" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-16-hydra : HIDE 1" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-15-hydra : HIDE 1" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-14-hydra : HIDE 1" >}}   |  {{< bg "PIGSTY 1.1.2" "postgresql-13-hydra : HIDE 1" >}}   |
