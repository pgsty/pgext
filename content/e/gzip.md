...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PGDG" link="/e/gzip" >}} | `1.0.1` | {{< bg "18" "pgsql_gzip_18*" "green" >}} {{< bg "17" "pgsql_gzip_17*" "green" >}} {{< bg "16" "pgsql_gzip_16*" "green" >}} {{< bg "15" "pgsql_gzip_15*" "green" >}} {{< bg "14" "pgsql_gzip_14*" "green" >}} | `pgsql_gzip_$v*` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/gzip" >}} | `1.0.1` | {{< bg "18" "postgresql-18-gzip" "red" >}} {{< bg "17" "postgresql-17-gzip" "green" >}} {{< bg "16" "postgresql-16-gzip" "green" >}} {{< bg "15" "postgresql-15-gzip" "green" >}} {{< bg "14" "postgresql-14-gzip" "green" >}} | `postgresql-$v-gzip` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    | {{< bg "PGDG 1.0.0" "pgsql_gzip_18 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_17 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_16 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_15 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_14 : AVAIL 1" "blue" >}} |
|    `el8.aarch64`    | {{< bg "PGDG 1.0.0" "pgsql_gzip_18 : AVAIL 1" "blue" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_16 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_15 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_14 : AVAIL 2" "green" >}} |
|    `el9.x86_64`    | {{< bg "PGDG 1.0.0" "pgsql_gzip_18 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_17 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_16 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_15 : AVAIL 1" "blue" >}} | {{< bg "PGDG 1.0.0" "pgsql_gzip_14 : AVAIL 1" "blue" >}} |
|    `el9.aarch64`    | {{< bg "PGDG 1.0.0" "pgsql_gzip_18 : AVAIL 1" "blue" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_17 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_16 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_15 : AVAIL 2" "green" >}} | {{< bg "PIGSTY 1.0.0" "pgsql_gzip_14 : AVAIL 2" "green" >}} |
|    `d12.x86_64`    |      {{< bg "MISS" "postgresql-18-gzip : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.1" "postgresql-17-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-16-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-15-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-14-gzip : AVAIL 1" "green" >}} |
|    `d12.aarch64`    |      {{< bg "MISS" "postgresql-18-gzip : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.1" "postgresql-17-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-16-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-15-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-14-gzip : AVAIL 1" "green" >}} |
|    `u22.x86_64`    |      {{< bg "MISS" "postgresql-18-gzip : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.1" "postgresql-17-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-16-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-15-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-14-gzip : AVAIL 1" "green" >}} |
|    `u22.aarch64`    |      {{< bg "MISS" "postgresql-18-gzip : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.1" "postgresql-17-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-16-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-15-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-14-gzip : AVAIL 1" "green" >}} |
|    `u24.x86_64`    |      {{< bg "MISS" "postgresql-18-gzip : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.1" "postgresql-17-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-16-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-15-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-14-gzip : AVAIL 1" "green" >}} |
|    `u24.aarch64`    |      {{< bg "MISS" "postgresql-18-gzip : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.1" "postgresql-17-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-16-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-15-gzip : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.1" "postgresql-14-gzip : AVAIL 1" "green" >}} |
...
{{< card link="/list" title="Source Tarball" icon="clipboard-list" subtitle="pgsql-gzip-1.0.1.tar.gz" >}}
{{< /cards >}}
