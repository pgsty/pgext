...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **4890** | {{< badge content="tsm_system_time" link="https://www.postgresql.org/docs/current/tsm-system-time.html" >}} | {{< ext "tsm_system_time" "tsm_system_time" >}} | `1.0` | {{< category "FUNC" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
