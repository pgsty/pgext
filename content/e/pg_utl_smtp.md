...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-utl-smtp : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-utl-smtp : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-utl-smtp : MISS 0" "red" >}}      |
