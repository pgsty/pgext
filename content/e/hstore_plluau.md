...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PGDG" link="/repo/pgdg" >}} | `2.0.12` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} | `pllua` | `hstore`, `plluau` |
...
| {{< os "el9.x86_64" >}} |      {{< bg "MISS" "pllua_18 : MISS 0" "red" >}}      | {{< bg "PGDG 2.0.12" "pllua_17 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_16 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_15 : AVAIL 3" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_14 : AVAIL 2" "blue" >}} |
| {{< os "el9.aarch64" >}} |      {{< bg "MISS" "pllua_18 : MISS 0" "red" >}}      | {{< bg "PGDG 2.0.12" "pllua_17 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_16 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_15 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_14 : AVAIL 1" "blue" >}} |
| {{< os "el10.x86_64" >}} |      {{< bg "MISS" "pllua_18 : MISS 0" "red" >}}      | {{< bg "PGDG 2.0.12" "pllua_17 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_16 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_15 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_14 : AVAIL 2" "blue" >}} |
| {{< os "el10.aarch64" >}} |      {{< bg "MISS" "pllua_18 : MISS 0" "red" >}}      | {{< bg "PGDG 2.0.12" "pllua_17 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_16 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_15 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.0.12" "pllua_14 : AVAIL 1" "blue" >}} |
