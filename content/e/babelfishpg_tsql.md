...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **9310** | {{< badge content="babelfishpg_tsql" link="https://babelfishpg.org/" >}} | {{< ext "babelfishpg_tsql" >}} | `5.5.0` | {{< category "SIM" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `5.5.0` | {{< bg "18" "" "red" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "red" >}} {{< bg "15" "" "red" >}} {{< bg "14" "" "red" >}} {{< bg "13" "" "red" >}} | `babelfishpg_tsql` | `babelfishpg_common`, `uuid-ossp` |
| **RPM** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `5.5.0` | {{< bg "18" "babelfishpg-tsql" "red" >}} {{< bg "17" "babelfishpg-tsql" "green" >}} {{< bg "16" "babelfishpg-tsql" "red" >}} {{< bg "15" "babelfishpg-tsql" "red" >}} {{< bg "14" "babelfishpg-tsql" "red" >}} {{< bg "13" "babelfishpg-tsql" "red" >}} | `babelfishpg-tsql` | `babelfishpg-common`, `libantlr4-runtime` |
| **DEB** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `5.5.0` | {{< bg "18" "babelfishpg-tsql" "red" >}} {{< bg "17" "babelfishpg-tsql" "green" >}} {{< bg "16" "babelfishpg-tsql" "red" >}} {{< bg "15" "babelfishpg-tsql" "red" >}} {{< bg "14" "babelfishpg-tsql" "red" >}} {{< bg "13" "babelfishpg-tsql" "red" >}} | `babelfishpg-tsql` | `babelfishpg-common`, `libantlr4-runtime4.9.3` |
