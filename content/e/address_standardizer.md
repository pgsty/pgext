...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **1505** | {{< badge content="address_standardizer" link="https://git.osgeo.org/gitea/postgis/postgis" >}} | {{< ext "address_standardizer" "postgis" >}} | `3.6.4` | {{< category "GIS" >}} | {{< license "GPL-2.0" >}} | {{< language "C" >}} |
