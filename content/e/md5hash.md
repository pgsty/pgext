...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-md5hash : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-md5hash : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-md5hash : MISS 0" "red" >}}      |
