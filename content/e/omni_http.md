...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2949** | {{< badge content="omni_http" link="https://docs.omnigres.org/omni_httpc/reference/" >}} | {{< ext "omni_http" "omnigres" >}} | `0.1.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
pig install omni_http;		# install by extension name, for the current active PG version

pig install omni_http -v 18;   # install for PG 18
pig install omni_http -v 17;   # install for PG 17
pig install omni_http -v 16;   # install for PG 16
pig install omni_http -v 15;   # install for PG 15
pig install omni_http -v 14;   # install for PG 14
