...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2959** | {{< badge content="omni_http" link="https://docs.omnigres.org/omni_httpc/reference/" >}} | {{< ext "omni_http" "omnigres" >}} | `0.1.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
