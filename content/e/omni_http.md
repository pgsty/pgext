...
[**omnigres**](https://docs.omnigres.org/omni_httpc/reference/)
...
```bash
pig build get omni_http; # get omni_http source code
pig build dep omni_http; # install build dependencies
pig build pkg omni_http; # build extension rpm or deb
pig build ext omni_http; # build extension rpms
```
...
pig ext install omni_http -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_http CASCADE SCHEMA omni_http;
```
