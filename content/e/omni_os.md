...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2958** | {{< badge content="omni_os" link="https://docs.omnigres.org/omni_os/intro/" >}} | {{< ext "omni_os" "omnigres" >}} | `0.1.1` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
pig install omni_os;		# install by extension name, for the current active PG version

pig install omni_os -v 18;   # install for PG 18
pig install omni_os -v 17;   # install for PG 17
pig install omni_os -v 16;   # install for PG 16
pig install omni_os -v 15;   # install for PG 15
pig install omni_os -v 14;   # install for PG 14
