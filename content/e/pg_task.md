...
| {{< os "d12.x86_64" >}} |      {{< bg "MISS" "postgresql-18-pg-task : MISS 0" "red" >}}      | {{< bg "PIGSTY 1.0.0" "postgresql-17-pg-task : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.0" "postgresql-16-pg-task : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.0" "postgresql-15-pg-task : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.0" "postgresql-14-pg-task : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.0" "postgresql-13-pg-task : AVAIL 1" "green" >}} |
