...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PGDG" link="/repo/pgdg" >}} | `1.0.0` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} | `pg_task` | - |
| **RPM** | {{< badge content="PGDG" link="/repo/pgdg" >}} | `2.1.7` | {{< bg "18" "pg_task_18" "green" >}} {{< bg "17" "pg_task_17" "green" >}} {{< bg "16" "pg_task_16" "green" >}} {{< bg "15" "pg_task_15" "green" >}} {{< bg "14" "pg_task_14" "green" >}} | `pg_task_$v` | - |
| **DEB** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `2.1.12` | {{< bg "18" "postgresql-18-pg-task" "green" >}} {{< bg "17" "postgresql-17-pg-task" "green" >}} {{< bg "16" "postgresql-16-pg-task" "green" >}} {{< bg "15" "postgresql-15-pg-task" "green" >}} {{< bg "14" "postgresql-14-pg-task" "green" >}} | `postgresql-$v-pg-task` | - |
...
| {{< os "el9.x86_64" >}} | {{< bg "PGDG 2.1.7" "pg_task_18 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_17 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_16 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_15 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_14 : AVAIL 2" "blue" >}} |
| {{< os "el9.aarch64" >}} | {{< bg "PGDG 2.1.7" "pg_task_18 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_17 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_16 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_15 : AVAIL 2" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_14 : AVAIL 2" "blue" >}} |
| {{< os "el10.x86_64" >}} | {{< bg "PGDG 2.1.7" "pg_task_18 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_17 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_16 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_15 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_14 : AVAIL 1" "blue" >}} |
| {{< os "el10.aarch64" >}} | {{< bg "PGDG 2.1.7" "pg_task_18 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_17 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_16 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_15 : AVAIL 1" "blue" >}} | {{< bg "PGDG 2.1.7" "pg_task_14 : AVAIL 1" "blue" >}} |
