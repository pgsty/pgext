...
|   **See Also**    | {{< ext "pg_graphql" >}} {{< ext "http" >}} {{< ext "pg_net" >}} {{< ext "documentdb" >}} {{< ext "pg_curl" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `0.1.1` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} | `omnigres` | `omni_httpd`, `omni_sql`, `omni_web`, `omni_var`, `pgcrypto` |
...
{{< cards cols=3 >}}
{{< card link="https://docs.omnigres.org/omni_rest/protocols/" title="Repository" icon="link" subtitle="docs.omnigres.org/omni_rest/protocols/" />}}
...
pig install omni_rest -v 14;   # install for PG 14
...
```sql
CREATE EXTENSION omni_rest CASCADE; -- requires omni_httpd, omni_sql, omni_web, omni_var, pgcrypto
```
...
> [omni_rest: REST API toolkit (with PostgREST support)](https://docs.omnigres.org/omni_rest/protocols/)

The `omni_rest` extension provides REST API functionality with basic PostgREST protocol compatibility.

The extension implements foundational support for the PostgREST protocol. Refer to the [PostgREST documentation](https://postgrest.org/) for protocol details.
