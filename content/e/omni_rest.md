...
```bash
pig build get omni_rest; # get omni_rest source code
pig build dep omni_rest; # install build dependencies
pig build pkg omni_rest; # build extension rpm or deb
pig build ext omni_rest; # build extension rpms
```
...
pig ext install omni_rest -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_rest CASCADE SCHEMA omni_rest;
```
