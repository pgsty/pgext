...
[**omnigres**](https://docs.omnigres.org/omni_cloudevents/cloud_events/)
...
```bash
pig build get omni_cloudevents; # get omni_cloudevents source code
pig build dep omni_cloudevents; # install build dependencies
pig build pkg omni_cloudevents; # build extension rpm or deb
pig build ext omni_cloudevents; # build extension rpms
```
...
pig ext install omni_cloudevents -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_cloudevents CASCADE SCHEMA omni_cloudevents;
```
