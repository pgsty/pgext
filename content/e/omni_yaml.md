...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2979** | {{< badge content="omni_yaml" link="https://docs.omnigres.org/omni_yaml/yaml/" >}} | {{< ext "omni_yaml" "omnigres" >}} | `0.1.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
|:-----------------:|:----|
|    **Schemas**    | `omni_yaml` |
|    **Need By**    | {{< ext "omni_kube" >}} {{< ext "omni_schema" >}} |
|   **See Also**    | {{< ext "pgjq" >}} {{< ext "pg_jsonschema" >}} {{< ext "jsonschema" >}} {{< ext "pgbson" >}} {{< ext "jsquery" >}} {{< ext "pg_projection" >}} |
...
pig install omni_yaml;		# install by extension name, for the current active PG version

pig install omni_yaml -v 18;   # install for PG 18
pig install omni_yaml -v 17;   # install for PG 17
pig install omni_yaml -v 16;   # install for PG 16
pig install omni_yaml -v 15;   # install for PG 15
pig install omni_yaml -v 14;   # install for PG 14
