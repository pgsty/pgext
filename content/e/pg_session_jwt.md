...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **7040** | {{< badge content="pg_session_jwt" link="https://github.com/neondatabase/pg_session_jwt" >}} | {{< ext "pg_session_jwt" >}} | `0.3.1` | {{< category "SEC" >}} | {{< license "Apache-2.0" >}} | {{< language "Rust" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PIGSTY" link="/e/pg_session_jwt" >}} | `0.3.1` | {{< bg "18" "pg_session_jwt_18" "red" >}} {{< bg "17" "pg_session_jwt_17" "green" >}} {{< bg "16" "pg_session_jwt_16" "green" >}} {{< bg "15" "pg_session_jwt_15" "green" >}} {{< bg "14" "pg_session_jwt_14" "green" >}} | `pg_session_jwt_$v` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/pg_session_jwt" >}} | `0.3.1` | {{< bg "18" "postgresql-18-pg-session-jwt" "red" >}} {{< bg "17" "postgresql-17-pg-session-jwt" "green" >}} {{< bg "16" "postgresql-16-pg-session-jwt" "green" >}} {{< bg "15" "postgresql-15-pg-session-jwt" "green" >}} {{< bg "14" "postgresql-14-pg-session-jwt" "green" >}} | `postgresql-$v-pg-session-jwt` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    |      {{< bg "MISS" "pg_session_jwt_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_14 : AVAIL 1" "green" >}} |
|    `el8.aarch64`    |      {{< bg "MISS" "pg_session_jwt_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_14 : AVAIL 1" "green" >}} |
|    `el9.x86_64`    |      {{< bg "MISS" "pg_session_jwt_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_14 : AVAIL 1" "green" >}} |
|    `el9.aarch64`    |      {{< bg "MISS" "pg_session_jwt_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "pg_session_jwt_14 : AVAIL 1" "green" >}} |
|    `d12.x86_64`    |      {{< bg "MISS" "postgresql-18-pg-session-jwt : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "postgresql-17-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-16-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-15-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-14-pg-session-jwt : AVAIL 1" "green" >}} |
|    `d12.aarch64`    |      {{< bg "MISS" "postgresql-18-pg-session-jwt : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "postgresql-17-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-16-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-15-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-14-pg-session-jwt : AVAIL 1" "green" >}} |
|    `u22.x86_64`    |      {{< bg "MISS" "postgresql-18-pg-session-jwt : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "postgresql-17-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-16-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-15-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-14-pg-session-jwt : AVAIL 1" "green" >}} |
|    `u22.aarch64`    |      {{< bg "MISS" "postgresql-18-pg-session-jwt : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "postgresql-17-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-16-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-15-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-14-pg-session-jwt : AVAIL 1" "green" >}} |
|    `u24.x86_64`    |      {{< bg "MISS" "postgresql-18-pg-session-jwt : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "postgresql-17-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-16-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-15-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-14-pg-session-jwt : AVAIL 1" "green" >}} |
|    `u24.aarch64`    |      {{< bg "MISS" "postgresql-18-pg-session-jwt : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.3.1" "postgresql-17-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-16-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-15-pg-session-jwt : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.3.1" "postgresql-14-pg-session-jwt : AVAIL 1" "green" >}} |
...
{{< card link="/list" title="Source Tarball" icon="clipboard-list" subtitle="pg_session_jwt-0.3.1.tar.gz" >}}
{{< /cards >}}
