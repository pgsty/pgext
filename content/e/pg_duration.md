...
| {{< os "el9.aarch64" >}} | {{< bg "PIGSTY 1.0.2" "pg_duration_18 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 1.0.2" "pg_duration_17 : AVAIL 1" "green" >}} |      {{< bg "MISS" "pg_duration_16 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_duration_15 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_duration_14 : MISS 0" "red" >}}      |      {{< bg "MISS" "pg_duration_13 : MISS 0" "red" >}}      |
