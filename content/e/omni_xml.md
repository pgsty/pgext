...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2988** | {{< badge content="omni_xml" link="https://docs.omnigres.org/omni_xml/overview/" >}} | {{< ext "omni_xml" "omnigres" >}} | `0.1.2` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
```bash
pig build get omni_xml; # get omni_xml source code
pig build dep omni_xml; # install build dependencies
pig build pkg omni_xml; # build extension rpm or deb
pig build ext omni_xml; # build extension rpms
```
...
```bash
CREATE EXTENSION omni_xml CASCADE SCHEMA omni_xml;
```
