...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-aws-s3 : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-aws-s3 : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-aws-s3 : MISS 0" "red" >}}      |
