...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2984** | {{< badge content="omni_vfs" link="https://docs.omnigres.org/omni_vfs/reference/" >}} | {{< ext "omni_vfs" "omnigres" >}} | `0.2.1` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
pig ext install omni_vfs -v 18;   # install for PG 18
