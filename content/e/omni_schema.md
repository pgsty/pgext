...
|   **See Also**    | {{< ext "ddlx" >}} {{< ext "pgdd" >}} {{< ext "pg_permissions" >}} {{< ext "pg_readme" >}} {{< ext "meta" >}} {{< ext "pg_catcheck" >}} {{< ext "set_user" >}} {{< ext "pg_roast" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `0.3.0` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} | `omnigres` | `omni_sql`, `omni_vfs`, `omni_polyfill`, `omni_yaml`, `dblink`, `postgres_fdw`, `omni_types`, `omni_cloudevents` |
...
pig install omni_schema;		# install by extension name, for the current active PG version

pig install omni_schema -v 18;   # install for PG 18
pig install omni_schema -v 17;   # install for PG 17
pig install omni_schema -v 16;   # install for PG 16
pig install omni_schema -v 15;   # install for PG 15
pig install omni_schema -v 14;   # install for PG 14
...
```sql
CREATE EXTENSION omni_schema CASCADE; -- requires omni_sql, omni_vfs, omni_polyfill, omni_yaml, dblink, postgres_fdw, omni_types, omni_cloudevents
```
