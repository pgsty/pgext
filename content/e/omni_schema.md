...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `0.3.0` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} {{< bg "13" "" "green" >}} | `omnigres` | `omni_sql`, `omni_vfs`, `omni_polyfill`, `omni_yaml`, `dblink`, `postgres_fdw`, `omni_types`, `omni_cloudevents` |
...
pig install omni_schema -v 13;   # install for PG 13
