...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PGDG" link="/e/credcheck" >}} | `3.0` | {{< bg "18" "credcheck_18*" "red" >}} {{< bg "17" "credcheck_17*" "green" >}} {{< bg "16" "credcheck_16*" "green" >}} {{< bg "15" "credcheck_15*" "green" >}} {{< bg "14" "credcheck_14*" "green" >}} | `credcheck_$v*` | - |
| **Debian** | {{< badge content="PGDG" link="/e/credcheck" >}} | `3.0` | {{< bg "18" "postgresql-18-credcheck" "green" >}} {{< bg "17" "postgresql-17-credcheck" "green" >}} {{< bg "16" "postgresql-16-credcheck" "green" >}} {{< bg "15" "postgresql-15-credcheck" "green" >}} {{< bg "14" "postgresql-14-credcheck" "green" >}} | `postgresql-$v-credcheck` | - |
...
|    `u22.aarch64`    | {{< bg "PGDG 3.0" "postgresql-18-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-17-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-16-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-15-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-14-credcheck : AVAIL 1" "blue" >}} |
|    `u24.x86_64`    | {{< bg "PGDG 3.0" "postgresql-18-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-17-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-16-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-15-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-14-credcheck : AVAIL 1" "blue" >}} |
|    `u24.aarch64`    | {{< bg "PGDG 3.0" "postgresql-18-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-17-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-16-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-15-credcheck : AVAIL 1" "blue" >}} | {{< bg "PGDG 3.0" "postgresql-14-credcheck : AVAIL 1" "blue" >}} |
