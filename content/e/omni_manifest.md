...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2966** | {{< badge content="omni_manifest" link="https://docs.omnigres.org/omni_manifest/usage/" >}} | {{< ext "omni_manifest" "omnigres" >}} | `0.1.2` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
```bash
pig build get omni_manifest; # get omni_manifest source code
pig build dep omni_manifest; # install build dependencies
pig build pkg omni_manifest; # build extension rpm or deb
pig build ext omni_manifest; # build extension rpms
```
...
```bash
CREATE EXTENSION omni_manifest CASCADE SCHEMA omni_manifest;
```
