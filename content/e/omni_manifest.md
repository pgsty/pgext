...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2956** | {{< badge content="omni_manifest" link="https://docs.omnigres.org/omni_manifest/usage/" >}} | {{< ext "omni_manifest" "omnigres" >}} | `0.1.2` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `0.1.2` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} | `omnigres` | - |
...
{{< cards cols=3 >}}
{{< card link="https://docs.omnigres.org/omni_manifest/usage/" title="Repository" icon="link" subtitle="docs.omnigres.org/omni_manifest/usage/" >}}
...
pig install omni_manifest;		# install by extension name, for the current active PG version

pig install omni_manifest -v 18;   # install for PG 18
pig install omni_manifest -v 17;   # install for PG 17
pig install omni_manifest -v 16;   # install for PG 16
pig install omni_manifest -v 15;   # install for PG 15
pig install omni_manifest -v 14;   # install for PG 14
