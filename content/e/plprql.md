...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PIGSTY" link="/e/plprql" >}} | `1.0.0` | {{< bg "18" "plprql_18" "red" >}} {{< bg "17" "plprql_17" "red" >}} {{< bg "16" "plprql_16" "green" >}} {{< bg "15" "plprql_15" "green" >}} {{< bg "14" "plprql_14" "green" >}} {{< bg "13" "plprql_13" "green" >}} | `plprql_$v` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/plprql" >}} | `1.0.0` | {{< bg "18" "postgresql-18-plprql" "red" >}} {{< bg "17" "postgresql-17-plprql" "red" >}} {{< bg "16" "postgresql-16-plprql" "green" >}} {{< bg "15" "postgresql-15-plprql" "green" >}} {{< bg "14" "postgresql-14-plprql" "green" >}} {{< bg "13" "postgresql-13-plprql" "green" >}} | `postgresql-$v-plprql` | - |
