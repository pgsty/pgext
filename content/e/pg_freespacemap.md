...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **6950** | {{< badge content="pg_freespacemap" link="https://www.postgresql.org/docs/current/pgfreespacemap.html" >}} | {{< ext "pg_freespacemap" "pg_freespacemap" >}} | `1.2` | {{< category "STAT" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
