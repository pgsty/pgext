...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **4980** | {{< badge content="dict_int" link="https://www.postgresql.org/docs/current/dict-int.html" >}} | {{< ext "dict_int" "dict_int" >}} | `1.0` | {{< category "FUNC" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
