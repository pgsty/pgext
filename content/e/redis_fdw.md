...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-redis-fdw : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-redis-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-redis-fdw : MISS 0" "red" >}}      |
