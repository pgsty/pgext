...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "percona-postgresql-18 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-17 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-16 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-15 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-14 : FORK 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "percona-postgresql-18 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-17 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-16 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-15 : FORK 0" "red" >}}      |      {{< bg "MISS" "percona-postgresql-14 : FORK 0" "red" >}}      |
