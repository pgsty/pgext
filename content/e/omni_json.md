...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2953** | {{< badge content="omni_json" link="https://docs.omnigres.org/omni_json/table_mapping/" >}} | {{< ext "omni_json" "omnigres" >}} | `0.1.1` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
pig install omni_json;		# install by extension name, for the current active PG version

pig install omni_json -v 18;   # install for PG 18
pig install omni_json -v 17;   # install for PG 17
pig install omni_json -v 16;   # install for PG 16
pig install omni_json -v 15;   # install for PG 15
pig install omni_json -v 14;   # install for PG 14
