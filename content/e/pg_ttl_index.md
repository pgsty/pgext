...
| {{< os "u26.x86_64" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-18-ttl-index : AVAIL 1" "green" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-17-ttl-index : AVAIL 1" "green" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-16-ttl-index : AVAIL 1" "green" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-15-ttl-index : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-14-ttl-index : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-18-ttl-index : AVAIL 1" "green" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-17-ttl-index : AVAIL 1" "green" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-16-ttl-index : AVAIL 1" "green" >}} | {{< bg "PIGSTY 3.0.0" "postgresql-15-ttl-index : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-14-ttl-index : MISS 0" "red" >}}      |
