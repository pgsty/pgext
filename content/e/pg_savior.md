...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PIGSTY" link="/e/pg_savior" >}} | `0.0.1` | {{< bg "18" "pg_savior_18*" "red" >}} {{< bg "17" "pg_savior_17*" "green" >}} {{< bg "16" "pg_savior_16*" "green" >}} {{< bg "15" "pg_savior_15*" "green" >}} {{< bg "14" "pg_savior_14*" "green" >}} {{< bg "13" "pg_savior_13*" "green" >}} | `pg_savior_$v*` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/pg_savior" >}} | `0.0.1` | {{< bg "18" "postgresql-18-pg-savior" "red" >}} {{< bg "17" "postgresql-17-pg-savior" "green" >}} {{< bg "16" "postgresql-16-pg-savior" "green" >}} {{< bg "15" "postgresql-15-pg-savior" "green" >}} {{< bg "14" "postgresql-14-pg-savior" "green" >}} {{< bg "13" "postgresql-13-pg-savior" "green" >}} | `postgresql-$v-pg-savior` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |                  **PG13**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    |      {{< bg "MISS" "pg_savior_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.0.1" "pg_savior_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.0.1" "pg_savior_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.0.1" "pg_savior_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.0.1" "pg_savior_14 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.0.1" "pg_savior_13 : AVAIL 1" "green" >}} |
