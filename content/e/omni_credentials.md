...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2945** | {{< badge content="omni_credentials" link="https://docs.omnigres.org/omni_credentials/credentials/" >}} | {{< ext "omni_credentials" "omnigres" >}} | `0.2.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EXT** | {{< badge content="PIGSTY" link="/repo/pgsql" >}} | `0.2.0` | {{< bg "18" "" "green" >}} {{< bg "17" "" "green" >}} {{< bg "16" "" "green" >}} {{< bg "15" "" "green" >}} {{< bg "14" "" "green" >}} | `omnigres` | `pgcrypto`, `omni_os` |
...
{{< cards cols=3 >}}
{{< card link="https://docs.omnigres.org/omni_credentials/credentials/" title="Repository" icon="link" subtitle="docs.omnigres.org/omni_credentials/credentials/" >}}
...
pig install omni_credentials -v 14;   # install for PG 14
...
```sql
CREATE EXTENSION omni_credentials CASCADE; -- requires pgcrypto, omni_os
```
