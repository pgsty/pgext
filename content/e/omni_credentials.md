...
[**omnigres**](https://docs.omnigres.org/omni_credentials/credentials/)
...
```bash
pig build get omni_credentials; # get omni_credentials source code
pig build dep omni_credentials; # install build dependencies
pig build pkg omni_credentials; # build extension rpm or deb
pig build ext omni_credentials; # build extension rpms
```
...
pig ext install omni_credentials -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_credentials CASCADE SCHEMA omni_credentials;
```
