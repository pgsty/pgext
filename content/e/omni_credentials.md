...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2956** | {{< badge content="omni_credentials" link="https://docs.omnigres.org/omni_credentials/credentials/" >}} | {{< ext "omni_credentials" "omnigres" >}} | `0.2.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
