...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PGDG" link="/e/pg_drop_events" >}} | `0.1.0` | {{< bg "18" "pg_drop_events_18" "red" >}} {{< bg "17" "pg_drop_events_17" "green" >}} {{< bg "16" "pg_drop_events_16" "green" >}} {{< bg "15" "pg_drop_events_15" "green" >}} {{< bg "14" "pg_drop_events_14" "green" >}} | `pg_drop_events_$v` | - |
| **Debian** | {{< badge content="PIGSTY" link="/e/pg_drop_events" >}} | `0.1.0` | {{< bg "18" "postgresql-18-pg-drop-events" "red" >}} {{< bg "17" "postgresql-17-pg-drop-events" "green" >}} {{< bg "16" "postgresql-16-pg-drop-events" "green" >}} {{< bg "15" "postgresql-15-pg-drop-events" "green" >}} {{< bg "14" "postgresql-14-pg-drop-events" "green" >}} | `postgresql-$v-pg-drop-events` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    |      {{< bg "MISS" "pg_drop_events_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "pg_drop_events_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_14 : AVAIL 1" "green" >}} |
|    `el8.aarch64`    |      {{< bg "MISS" "pg_drop_events_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "pg_drop_events_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_14 : AVAIL 1" "green" >}} |
|    `el9.x86_64`    |      {{< bg "MISS" "pg_drop_events_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "pg_drop_events_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_14 : AVAIL 1" "green" >}} |
|    `el9.aarch64`    |      {{< bg "MISS" "pg_drop_events_18 : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "pg_drop_events_17 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_16 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_15 : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "pg_drop_events_14 : AVAIL 1" "green" >}} |
|    `d12.x86_64`    |      {{< bg "MISS" "postgresql-18-pg-drop-events : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "postgresql-17-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-16-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-15-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-14-pg-drop-events : AVAIL 1" "green" >}} |
|    `d12.aarch64`    |      {{< bg "MISS" "postgresql-18-pg-drop-events : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "postgresql-17-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-16-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-15-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-14-pg-drop-events : AVAIL 1" "green" >}} |
|    `u22.x86_64`    |      {{< bg "MISS" "postgresql-18-pg-drop-events : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "postgresql-17-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-16-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-15-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-14-pg-drop-events : AVAIL 1" "green" >}} |
|    `u22.aarch64`    |      {{< bg "MISS" "postgresql-18-pg-drop-events : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "postgresql-17-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-16-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-15-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-14-pg-drop-events : AVAIL 1" "green" >}} |
|    `u24.x86_64`    |      {{< bg "MISS" "postgresql-18-pg-drop-events : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "postgresql-17-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-16-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-15-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-14-pg-drop-events : AVAIL 1" "green" >}} |
|    `u24.aarch64`    |      {{< bg "MISS" "postgresql-18-pg-drop-events : MISS 0" "red" >}}      | {{< bg "PIGSTY 0.1.0" "postgresql-17-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-16-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-15-pg-drop-events : AVAIL 1" "green" >}} | {{< bg "PIGSTY 0.1.0" "postgresql-14-pg-drop-events : AVAIL 1" "green" >}} |
