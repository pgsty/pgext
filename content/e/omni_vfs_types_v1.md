...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2985** | {{< badge content="omni_vfs_types_v1" link="https://github.com/omnigres/omnigres" >}} | {{< ext "omni_vfs_types_v1" "omnigres" >}} | `0.1.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
```bash
pig build get omni_vfs_types_v1; # get omni_vfs_types_v1 source code
pig build dep omni_vfs_types_v1; # install build dependencies
pig build pkg omni_vfs_types_v1; # build extension rpm or deb
pig build ext omni_vfs_types_v1; # build extension rpms
```
...
pig ext install omni_vfs_types_v1 -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_vfs_types_v1 CASCADE SCHEMA omni_vfs_types_v1;
```
