...
[**hunspell**](https://github.com/postgrespro/hunspell_dicts) : Dutch Hunspell Dictionary
...
|    **Siblings**   | {{< ext "hunspell_cs_cz" >}} {{< ext "hunspell_de_de" >}} {{< ext "hunspell_en_us" >}} {{< ext "hunspell_fr" >}} {{< ext "hunspell_ne_np" >}} {{< ext "hunspell_nn_no" >}} {{< ext "hunspell_pt_pt" >}} {{< ext "hunspell_ru_ru" >}} {{< ext "hunspell_ru_ru_aot" >}} |
...
pig install hunspell_nl_nl;		# install by extension name, for the current active PG version
