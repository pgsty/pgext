...
| {{< os "d13.aarch64" >}} |      {{< bg "MISS" "postgresql-18-log-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-log-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-log-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-log-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-log-fdw : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-13-log-fdw : MISS 0" "red" >}}      |
