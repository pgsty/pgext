...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-external-file : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-external-file : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-external-file : MISS 0" "red" >}}      |
