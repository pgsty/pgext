...
| {{< os "u26.x86_64" >}} | {{< bg "PIGSTY 1.0.0" "postgresql-18-onesparse : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-onesparse : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-onesparse : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-onesparse : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-onesparse : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} | {{< bg "PIGSTY 1.0.0" "postgresql-18-onesparse : AVAIL 1" "green" >}} |      {{< bg "MISS" "postgresql-17-onesparse : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-onesparse : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-onesparse : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-onesparse : MISS 0" "red" >}}      |
