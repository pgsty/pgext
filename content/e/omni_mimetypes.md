...
[**omnigres**](https://docs.omnigres.org/omni_mimetypes/reference/)
...
```bash
pig build get omni_mimetypes; # get omni_mimetypes source code
pig build dep omni_mimetypes; # install build dependencies
pig build pkg omni_mimetypes; # build extension rpm or deb
pig build ext omni_mimetypes; # build extension rpms
```
...
pig ext install omni_mimetypes -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_mimetypes CASCADE SCHEMA omni_mimetypes;
```
