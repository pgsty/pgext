...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2957** | {{< badge content="omni_mimetypes" link="https://docs.omnigres.org/omni_mimetypes/reference/" >}} | {{< ext "omni_mimetypes" "omnigres" >}} | `0.1.0` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
{{< cards cols=3 >}}
{{< card link="https://docs.omnigres.org/omni_mimetypes/reference/" title="Repository" icon="link" subtitle="docs.omnigres.org/omni_mimetypes/reference/" >}}
...
pig install omni_mimetypes;		# install by extension name, for the current active PG version

pig install omni_mimetypes -v 18;   # install for PG 18
pig install omni_mimetypes -v 17;   # install for PG 17
pig install omni_mimetypes -v 16;   # install for PG 16
pig install omni_mimetypes -v 15;   # install for PG 15
pig install omni_mimetypes -v 14;   # install for PG 14
