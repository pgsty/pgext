...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **8630** | {{< badge content="db2_fdw" link="https://github.com/wolfgangbrandl/db2_fdw" >}} | {{< ext "db2_fdw" "db2_fdw" >}} | `7.0.0` | {{< category "FDW" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
...
|:----:|:----:|:-------:|:---------------------:|:----------------|:------------:|
| **EL** | {{< badge content="PGDG" link="/e/db2_fdw" >}} | `7.0.0` | {{< badge content="18" color="red" alt="db2_fdw_18*" >}} {{< badge content="17" color="red" alt="db2_fdw_17*" >}} {{< badge content="16" color="green" >}} {{< badge content="15" color="green" >}} {{< badge content="14" color="green" >}} | `db2_fdw_$v*` | - |


| **Linux** / **PG** |                  **PG18**                   |                  **PG17**                   |                  **PG16**                   |                  **PG15**                   |                  **PG14**                   |
|:------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|:-------------------------------------------:|
|    `el8.x86_64`    |    {{< pkg "db2_fdw_18" >}}     | {{< pkg "db2_fdw_17" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/17/redhat/rhel-8-x86_64/db2_fdw_17-7.0.0-1PGDG.rhel8.x86_64.rpm" >}} | {{< pkg "db2_fdw_16" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/16/redhat/rhel-8-x86_64/db2_fdw_16-7.0.0-1PGDG.rhel8.x86_64.rpm" >}} | {{< pkg "db2_fdw_15" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/15/redhat/rhel-8-x86_64/db2_fdw_15-7.0.0-1PGDG.rhel8.x86_64.rpm" >}} | {{< pkg "db2_fdw_14" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/14/redhat/rhel-8-x86_64/db2_fdw_14-7.0.0-1PGDG.rhel8.x86_64.rpm" >}} |
|    `el8.aarch64`    |    {{< pkg "db2_fdw_18" >}}     |    {{< pkg "db2_fdw_17" >}}     |    {{< pkg "db2_fdw_16" >}}     |    {{< pkg "db2_fdw_15" >}}     |    {{< pkg "db2_fdw_14" >}}     |
|    `el9.x86_64`    |    {{< pkg "db2_fdw_18" >}}     | {{< pkg "db2_fdw_17" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/17/redhat/rhel-9-x86_64/db2_fdw_17-7.0.0-1PGDG.rhel9.x86_64.rpm" >}} | {{< pkg "db2_fdw_16" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/16/redhat/rhel-9-x86_64/db2_fdw_16-7.0.0-1PGDG.rhel9.x86_64.rpm" >}} | {{< pkg "db2_fdw_15" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/15/redhat/rhel-9-x86_64/db2_fdw_15-7.0.0-1PGDG.rhel9.x86_64.rpm" >}} | {{< pkg "db2_fdw_14" "7.0.0" "pgdg" "https://download.postgresql.org/pub/repos/yum/non-free/14/redhat/rhel-9-x86_64/db2_fdw_14-7.0.0-1PGDG.rhel9.x86_64.rpm" >}} |
|    `el9.aarch64`    |    {{< pkg "db2_fdw_18" >}}     |    {{< pkg "db2_fdw_17" >}}     |    {{< pkg "db2_fdw_16" >}}     |    {{< pkg "db2_fdw_15" >}}     |    {{< pkg "db2_fdw_14" >}}     |
...
{{< card link="/list" icon="clipboard-list"  title="Source Tarball" subtitle="db2_fdw-6.0.1.tar.gz" >}}
{{< /cards >}}
