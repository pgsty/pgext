...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **2974** | {{< badge content="omni_seq" link="https://docs.omnigres.org/omni_seq/id/" >}} | {{< ext "omni_seq" "omnigres" >}} | `0.1.1` | {{< category "FEAT" >}} | {{< license "Apache-2.0" >}} | {{< language "C" >}} |
...
```bash
pig build get omni_seq; # get omni_seq source code
pig build dep omni_seq; # install build dependencies
pig build pkg omni_seq; # build extension rpm or deb
pig build ext omni_seq; # build extension rpms
```
...
pig ext install omni_seq -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_seq CASCADE SCHEMA omni_seq;
```
