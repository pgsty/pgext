...
| {{< os "u26.x86_64" >}} |      {{< bg "MISS" "postgresql-18-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-ai-query : MISS 0" "red" >}}      |
| {{< os "u26.aarch64" >}} |      {{< bg "MISS" "postgresql-18-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-17-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-16-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-15-ai-query : MISS 0" "red" >}}      |      {{< bg "MISS" "postgresql-14-ai-query : MISS 0" "red" >}}      |
