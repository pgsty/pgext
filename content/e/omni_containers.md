...
[**omnigres**](https://docs.omnigres.org/omni_containers/intro/)
...
```bash
pig build get omni_containers; # get omni_containers source code
pig build dep omni_containers; # install build dependencies
pig build pkg omni_containers; # build extension rpm or deb
pig build ext omni_containers; # build extension rpms
```
...
pig ext install omni_containers -v 18;   # install for PG 18
...
```bash
CREATE EXTENSION omni_containers CASCADE SCHEMA omni_containers;
```
