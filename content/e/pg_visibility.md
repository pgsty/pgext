...
|:--------:|:---------:|:----------:|:-------:|:----------------------:|:----------------------------:|:--------------------:|
| **6960** | {{< badge content="pg_visibility" link="https://www.postgresql.org/docs/current/pgvisibility.html" >}} | {{< ext "pg_visibility" "pg_visibility" >}} | `1.2` | {{< category "STAT" >}} | {{< license "PostgreSQL" >}} | {{< language "C" >}} |
