...
repo_upstream_default:
  ...
  - { name: percona        ,description: 'Percona TDE'        ,module: percona ,releases: [8,9,10] ,arch: [x86_64, aarch64] ,baseurl: { default: 'https://repo.percona.com/ppg-18.4/yum/release/$releasever/RPMS/$basearch'  }}
